        ...
        <div className="py-20 sm:py-28">
          ...
          <div className="py-20 sm:py-28 text-center">
            ...
            <div className="mt-12 text-left">
              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Your All-in-One Location Analysis Toolkit</h2>
            </div>
            <div className="mt-10 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 text-left">
              <div className="p-8 bg-[#1e293b] rounded-xl border border-gray-700">
                ...
                <h3 className="mt-6 text-lg font-semibold text-white">See the Full Picture with 360° Location Analysis</h3>
              ...
              <div className="p-8 bg-[#1e293b] rounded-xl border border-gray-700">
                ...
                <h3 className="mt-6 text-lg font-semibold text-white">Outsmart the Market with Competitor Intelligence</h3>
                <p className="mt-2 text-base text-gray-400">
